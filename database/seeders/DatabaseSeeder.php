...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $kelas = [
            ["tingkat_id" => "1","nama" => "RPL", "nomor" => "1"],
            ["tingkat_id" => "1","nama" => "RPL", "nomor" => "2"],
            ["tingkat_id" => "1","nama" => "TKJ", "nomor" => "1"],
            ["tingkat_id" => "1","nama" => "TKJ", "nomor" => "2"],
            ["tingkat_id" => "1","nama" => "TKJ", "nomor" => "3"],
            ["tingkat_id" => "1","nama" => "AK", "nomor" => "1"],
            ["tingkat_id" => "1","nama" => "AK", "nomor" => "2"],
            ["tingkat_id" => "1","nama" => "AK", "nomor" => "3"],
            ["tingkat_id" => "1","nama" => "AK", "nomor" => "4"],
            ["tingkat_id" => "1","nama" => "AP", "nomor" => "1"],
            ["tingkat_id" => "1","nama" => "AP", "nomor" => "2"],
            ["tingkat_id" => "1","nama" => "AP", "nomor" => "3"],
            ["tingkat_id" => "1","nama" => "AP", "nomor" => "4"],
            ["tingkat_id" => "1","nama" => "AP", "nomor" => "5"],
            ["tingkat_id" => "1","nama" => "PS", "nomor" => "1"],
            ["tingkat_id" => "1","nama" => "PS", "nomor" => "2"],
            ["tingkat_id" => "1","nama" => "PS", "nomor" => "3"],
            
            ["tingkat_id" => "2","nama" => "RPL", "nomor" => "1"],
            ["tingkat_id" => "2","nama" => "RPL", "nomor" => "2"],
            ["tingkat_id" => "2","nama" => "TKJ", "nomor" => "1"],
            ["tingkat_id" => "2","nama" => "TKJ", "nomor" => "2"],
            ["tingkat_id" => "2","nama" => "TKJ", "nomor" => "3"],
            ["tingkat_id" => "2","nama" => "AK", "nomor" => "1"],
            ["tingkat_id" => "2","nama" => "AK", "nomor" => "2"],
            ["tingkat_id" => "2","nama" => "AK", "nomor" => "3"],
            ["tingkat_id" => "2","nama" => "AK", "nomor" => "4"],
            ["tingkat_id" => "2","nama" => "AP", "nomor" => "1"],
            ["tingkat_id" => "2","nama" => "AP", "nomor" => "2"],
            ["tingkat_id" => "2","nama" => "AP", "nomor" => "3"],
            ["tingkat_id" => "2","nama" => "AP", "nomor" => "4"],
            ["tingkat_id" => "2","nama" => "AP", "nomor" => "5"],
            ["tingkat_id" => "2","nama" => "PS", "nomor" => "1"],
            ["tingkat_id" => "2","nama" => "PS", "nomor" => "2"],
            ["tingkat_id" => "2","nama" => "PS", "nomor" => "3"],

            ["tingkat_id" => "3","nama" => "RPL", "nomor" => "1"],
            ["tingkat_id" => "3","nama" => "RPL", "nomor" => "2"],
            ["tingkat_id" => "3","nama" => "TKJ", "nomor" => "1"],
            ["tingkat_id" => "3","nama" => "TKJ", "nomor" => "2"],
            ["tingkat_id" => "3","nama" => "TKJ", "nomor" => "3"],
            ["tingkat_id" => "3","nama" => "AK", "nomor" => "1"],
            ["tingkat_id" => "3","nama" => "AK", "nomor" => "2"],
            ["tingkat_id" => "3","nama" => "AK", "nomor" => "3"],
            ["tingkat_id" => "3","nama" => "AK", "nomor" => "4"],
            ["tingkat_id" => "3","nama" => "AP", "nomor" => "1"],
            ["tingkat_id" => "3","nama" => "AP", "nomor" => "2"],
            ["tingkat_id" => "3","nama" => "AP", "nomor" => "3"],
            ["tingkat_id" => "3","nama" => "AP", "nomor" => "4"],
            ["tingkat_id" => "3","nama" => "AP", "nomor" => "5"],
            ["tingkat_id" => "3","nama" => "PS", "nomor" => "1"],
            ["tingkat_id" => "3","nama" => "PS", "nomor" => "2"],
            ["tingkat_id" => "3","nama" => "PS", "nomor" => "3"],
        ];
